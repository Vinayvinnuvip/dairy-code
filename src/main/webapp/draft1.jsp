...
<body>
		...
		<div class="menu-bar">
			<div class="menu">
				...
				<ul class="menu-links">
					...
					<li class="active1 nav-links"><a href="getalldraft"> <i
	...
	<section class="home">
		<h1>Draft</h1>
		<%
		List<Draft> list = (List) request.getAttribute("draftlist");
		for (Draft e : list) {
			String e1 = e.getDate_time();
		%>
		<table>
		<tr >
		<td rowspan=3><img style="border-radius:0px" src="getdraftimage?date=<%=e1%>"  ></td>
		<td>
		<h2><%=e.getDisc() %></h2></td>
		</tr>
		<tr>
		...
		<tr><td>	
		<a href="removedraft?id=<%=e1%>"><i class='bx bx-trash'></i></a>
</td>
</tr>
<%
		}
