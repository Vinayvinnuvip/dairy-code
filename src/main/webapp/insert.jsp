...
<body>
	...
	<section class="home">
		<h1>Post Your Memory</h1>
					<h1><%=u.getEmail()%></h1>
					<br> <br>
				<form class="img" enctype="multipart/form-data" action="saveimagegallary?email=<%=u.getEmail() %>" method="post">
					<input type="file" name="image"><br>
					<textarea rows="5" cols="50" name="disc">enter text..</textarea>
					<br>
					<input type="submit" value="Save">
					
				</form>
				<a href="draft.jsp"><button>Draft</button></a>
	</section>
	<%
	} else {
	%>
