...
<%@page import="com.jsp.dto.Favorite"%>
...
<body>
		...
		<div class="menu-bar">
			<div class="menu">
				...
				<ul class="menu-links">
					...
					<li class="active1 nav-links"><a href="getallfav"> <i
	...
	<section class="home">
		<h1>Favorites</h1>
		<%
		List<Favorite> list = (List) request.getAttribute("favlist");
		for (Favorite e : list) {
			String e1 = e.getDate_time();
		%>
		<table>
		<tr >
		<td rowspan=3><img style="border-radius:0px" src="getfavimage?date=<%=e1%>"  ></td>
		<td>
		<h2><%=e.getDisc() %></h2></td>
		</tr>
		<tr>
		...
		<tr><td>	
		<a href="removefav?id=<%=e1%>"><i class='bx bx-trash'></i></a>
</td>
</tr>
<%
		}
