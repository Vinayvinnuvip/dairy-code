...
<body>
	...
	<nav class="sidebar ">
		...
		<div class="menu-bar">
			<div class="menu">
				...
				<ul class="menu-links">
					<li class="active1 nav-links "><a href="home.jsp"> <i
	...
	<section class="home">
		...
		<div class="home1">
		<%
		List<User> list = (List) request.getAttribute("image");
		for (User e : list) {
			String e1 = e.getEmail();
		%>
		<div class="allUser">
		<img alt=""  src="get?email=<%=e1%>"  style="padding:5px">
		<h2><%=e.getFname() %>&nbsp<%=e.getLname() %></h2>
		</div>
		<%
		}
		%>
